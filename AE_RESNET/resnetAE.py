...
class ResNetAE:
    ...
    def build_model(self):
        ...
        model = Model(inputs = input, outputs = decoder, name='ResNetAE')
        return model
    ...
    def fit(self, x, y, batch_size, epochs, callbacks, validation_data=None, shuffle=True, validation_split=0.2):
    ...
    def fit_generator(self, generator, steps_per_epoch, epochs, validation_data, validation_steps, callbacks):
        return self.model.fit_generator(generator, steps_per_epoch=steps_per_epoch, epochs=epochs, validation_data=validation_data, validation_steps=validation_steps, callbacks=callbacks)
    ...
    def evaluate(self, y_test, y_pred):
        s = ssim(y_test, y_pred, data_range=y_test.max() - y_test.min())
